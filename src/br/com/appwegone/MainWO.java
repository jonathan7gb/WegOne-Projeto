...
//===========================================================================================================
				...
				if(tipoUser.equals("admin")){
			        do {
			            ...
			            System.out.println("╚═════════════════════════════════════╝");
			            System.out.println("  1 - 📝 Conseils pour l'inscription   ");
			            System.out.println("  2 - 🔍 Guide de recherche            ");
			            System.out.println("  3 - ✏️ Modifier le guide             ");
			            System.out.println("  4 - 🗑️ Supprimer le guidage          ");
						...
						case 2:
							System.out.println("\n╔═════════════════════════════════════╗");
				            System.out.println("║       RECHERCHE D'ORIENTATION       ║");
				            System.out.println("╚═════════════════════════════════════╝");
				            System.out.println("  1 - 🧾 Toutes les directives       ");
				            System.out.println("  2 - 📄 Conseils spécifiques        ");
				            System.out.println("═══════════════════════════════════════");
				            System.out.print("  ? - Votre choix: ");
							escolhaPesquisa = leiaNum.nextInt();
							...
							case 2 :
								System.out.println("\n╔═════════════════════════════════════╗");
					            System.out.println("║         RECHERCHE SPÉCIFIQUE        ║");
					            System.out.println("╚═════════════════════════════════════╝");
					            System.out.println("  1 - 📊 Recherche par type          ");
					            System.out.println("  2 - 📊 Recherche par code        ");
					            System.out.println("  3 - 📊 Recherche par titre        ");
					            System.out.println("═══════════════════════════════════════");
					            System.out.print("  ? - Votre choix de recherche: ");
								escolhaBuscaEspecifica = leiaNum.nextInt(); 
								
								switch(escolhaBuscaEspecifica) { //MENU DE PESQUISA ESPECÍFICA
								case 1: 
									System.out.println("\n╔═══════════════════════════════════════════════╗");
						            System.out.println("║             PAR TYPE D'ORIENTATION            ║");
						            System.out.println("╚═══════════════════════════════════════════════╝");
								...
								case 2:
									System.out.println("\n╔═════════════════════════════════════╗");
						            System.out.println("║      PAR LE CODE D'ORIENTATION      ║");
						            System.out.println("╚═════════════════════════════════════╝");
						            System.out.println("  2 - 📊 Recherche par code               ");
						            System.out.println("══════════════════════════════════════");
								...
								case 3: 
									System.out.println("\n╔═════════════════════════════════════╗");
						            System.out.println("║        PAR LE TITRE DU GUIDE        ║");
						            System.out.println("╚═════════════════════════════════════╝");
						            System.out.println("  3 - 📊 Recherche par titre              ");
						            System.out.println("══════════════════════════════════════");
			...
			break; // BREAK DO CASE 1 DO BLOCO switch(escolhaIdioma) Francais
			} //Chave que fecha o if(tipoUser.equals("admin"))
				...
				do {
					...
					System.out.println("║            SYSTÈME WEGONE           ║");
					System.out.println("╚═════════════════════════════════════╝");
					System.out.println("  1 - 🔍 Guide de recherche        ");
...
//===========================================================================================================	
				...
				case 5: //Español
				tipoUser = Usuarios.menu_login_es();
				if(tipoUser.equals("admin")){
			        do {
			        	System.out.println("╔═════════════════════════════════════╗");
			            System.out.println("║            SISTEMA WEGONE           ║");
			            System.out.println("╚═════════════════════════════════════╝");
			            System.out.println("  1 - 📝 Orientación de registro        ");
			            System.out.println("  2 - 🔍 Búsqueda de Orientación        ");
			            System.out.println("  3 - ✏️ Editar orientación           ");
			            System.out.println("  4 - 🗑️ Quitar orientación          ");
			            System.out.println("  5 - 👋 Sistema de salida            ");
			            System.out.println("═══════════════════════════════════════");
						...
						switch(escolhaMenu) { //MENU PRINCIPAL 
						case 1:
							Espanhol.cadastrar_orientacoes_espanhol(leiaStr, leiaNum);
						break; // BREAK DO CASE 1 DO BLOCO switch(escolhaMenu)
						...
						case 2:
							System.out.println("\n╔═════════════════════════════════════╗");
							System.out.println("║      BÚSQUEDA DE ORIENTACIÓN        ║");
							System.out.println("╚═════════════════════════════════════╝");
							System.out.println("  1 - 🧾 Todas las orientaciones       ");
							System.out.println("  2 - 📄 Orientación específica        ");
							System.out.println("═══════════════════════════════════════");
							System.out.print("  ? - Tu elección: ");
							escolhaPesquisa = leiaNum.nextInt();
							...
							switch(escolhaPesquisa) { //MENU DE PESQUISA
							case 1:
								Espanhol.listar_todas_orientacoes_espanhol();
							break; // BREAK DO CASE 1 DO BLOCO switch(escolhaPesquisa)
							...
							case 2 :
								...
								System.out.println("  2 - 📊 Buscar por identificación       ");
								System.out.println("  3 - 📊 Buscar por título        ");
								System.out.println("═══════════════════════════════════════");
								System.out.print("  ? - Tu opción de búsqueda : ");
								escolhaBuscaEspecifica = leiaNum.nextInt(); 
								
								switch(escolhaBuscaEspecifica) { //MENU DE PESQUISA ESPECÍFICA
								case 1: 
									System.out.println("\n╔═══════════════════════════════════════════════╗");
									System.out.println("║             POR TIPO DE ORIENTACIÓN           ║");
									System.out.println("╚═══════════════════════════════════════════════╝");
									System.out.println("  1 - 📊 Buscar por tipo          ");
									System.out.println("═════════════════════════════════════════════════");
									System.out.println("  1 - 🗂️ Manual de operación                       ");
									System.out.println("  2 - 🗂️ Procedimiento de seguridad                       ");
									System.out.println("  3 - 🗂️ Mantenimiento y Reparaciones               ");
							        ...
							        Espanhol.listar_orientacoes_espanhol_pelo_tipo(tipoLeitura);
								...
								case 2:
									System.out.println("\n╔═════════════════════════════════════╗");
									System.out.println("║          POR ORIENTACIÓN ID          ║");
									System.out.println("╚═════════════════════════════════════╝");
									System.out.println("  2 - 📊 Buscar por identificación               ");
									System.out.println("══════════════════════════════════════");
									System.out.print("  ? - Ingrese la identificación: ");
							        int codigo_orientacao = leiaNum.nextInt();
							        Espanhol.listar_orientacao_pelo_codigo_espanhol(codigo_orientacao);
								break;	// BREAK DO CASE 2 DO BLOCO switch(escolhaBuscaEspecifica)
								...
								case 3: 
									System.out.println("\n╔═════════════════════════════════════╗");
									System.out.println("║        POR TÍTULO DE ORIENTACIÓN        ║");
									System.out.println("╚═════════════════════════════════════╝");
									System.out.println("  3 - 📊 Buscar por título               ");
									System.out.println("══════════════════════════════════════");
									System.out.print("  ? - Introduce el título: ");
							    	String titulo_orientacao = leiaStr.nextLine();
							    	Espanhol.listar_orientacao_pelo_titulo_espanhol(titulo_orientacao);
								break; // BREAK DO CASE 3 DO BLOCO switch(escolhaBuscaEspecifica)
						...
						case 3:
							Espanhol.editar_orientaçao_titulo_pelo_id_espanhol(leiaNum, leiaStr);
						break; // BREAK DO CASE 3 DO BLOCO switch(escolhaMenu)
							
						//------------------------------------------------------------
							
						case 4:
							Espanhol.deletar_orientação_espanhol(leiaNum);
						break; // BREAK DO CASE 4 DO BLOCO switch(escolhaMenu)
							
						//------------------------------------------------------------
								
						case 5: 
							Espanhol.mensagem_sair_sistema_espanhol();
						break; // BREAK DO CASE 5 DO BLOCO switch(escolhaMenu)
			...
			break; // BREAK DO CASE 1 DO BLOCO switch(escolhaIdioma) Español
			} //Chave que fecha o if(tipoUser.equals("admin"))
				...
				do {
			        ...
			        System.out.println("║            SISTEMA WEGONE           ║");
			        System.out.println("╚═════════════════════════════════════╝");
			        System.out.println("  1 - 🔍 Búsqueda de Orientación        ");
			        System.out.println("  2 - 👋 Sistema de salida                       ");
			        System.out.println("═══════════════════════════════════════");
					System.out.print("  ? - Tu elección: ");
					escolhaMenu = leiaNum.nextInt(); //Escolha do usuário no menu
